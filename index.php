...
<head>
    ...
    <title>TixBox Account Registration</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for joining TixBox! To complete your registration, please verify your email address by clicking the link below or copying it into your browser's address bar:</p>
            <a href="mailto:support@tixbox.com" class="verify-button">Verify My Email</a><br>
            <br>
            <p>Please note that this link will expire in 24 hours.</p>
<p>If you have any questions or need assistance, feel free to contact us using the details below.
</p>
